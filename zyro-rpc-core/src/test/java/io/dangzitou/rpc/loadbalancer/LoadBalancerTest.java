...
import io.dangzitou.rpc.loadbalancer.impl.ConsistentHashLoadBalancer;
...
public class LoadBalancerTest {
    ...
    public void select(){
        ...
        requestParams.put("methodName", "get");
        //服务列表
        ...
        serviceMetaInfo2.setServiceHost("dangzitou.github.io");
